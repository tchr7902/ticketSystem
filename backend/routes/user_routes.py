    ...
    try:
        ...
        if space_info:
            ...
            message_text = (
                ...
                f"If you have any *urgent issues*, please reach out to the IT team directly.\n\n"
                f"Thank you!"
            )
